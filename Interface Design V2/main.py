...
#sources:
    #https://www.geeksforgeeks.org/python-program-check-string-contains-special-character/ <- Check for if string has characters (regex)
    #https://nordpass.com/most-common-passwords-list/ <- Most common passwords
